            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-2xl font-bold tracking-tight">Create Meal Plan</h1>
                            <p class="text-muted-foreground">Add a new meal plan to your offerings</p>
                        </div>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription> Fill in the information below to create a new meal plan </CardDescription>
                        </CardHeader>
                        <CardContent>
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <div class="rounded-lg border-2 border-dashed border-gray-300 p-6 text-center">
                                                <div v-if="imagePreview" class="mb-4">
                                                    <img :src="imagePreview" alt="Preview" class="mx-auto h-32 w-32 rounded-lg object-cover" />
                                                </div>
...
const submit = (): void => {
    ...
    form.post(route('admin.meal-plans.store'), {
        onFinish: () => {
